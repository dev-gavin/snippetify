...
export default function JiraTicket() {
    ...
    const [jiraTicket, setJiraTicket, removeJiraTicket] = useLocalStorage("jiraTicket", defaultValues);
        ...
        <>
            <div>
                <form>
                    ...
                    <label>
                        <input {...register("testingEvnironments")} type="checkbox" value="UAT" />
                        UAT
                    </label>

                    <label>
                        <input {...register("testingEvnironments")} type="checkbox" value="Inttest" />
                        Inttest
                    </label>

                    <label>
                        <input {...register("testingEvnironments")} type="checkbox" value="UATCJE" />
                        UAT CJE
                    </label>

                    <label>
                        <input {...register("testingEvnironments")} type="checkbox" value="QA10" />
                        QA10
                    </label>
                </form>
